...
- `<CountdownMini>` | `<countdown-mini>` (components/CountdownMini.vue)
- `<CountdownShop>` | `<countdown-shop>` (components/CountdownShop.vue)
- `<ForgotPasswordContainer>` | `<forgot-password-container>` (components/ForgotPasswordContainer.vue)
- `<GiftModal>` | `<gift-modal>` (components/GiftModal.vue)
...
- `<ProductWrapperCosmeticsCart>` | `<product-wrapper-cosmetics-cart>` (components/product/ProductWrapperCosmeticsCart.vue)
- `<ProductWrapperCosmeticsTwo>` | `<product-wrapper-cosmetics-two>` (components/product/ProductWrapperCosmeticsTwo.vue)
- `<ProductWrapperCosmeticsTwoDetail>` | `<product-wrapper-cosmetics-two-detail>` (components/product/ProductWrapperCosmeticsTwoDetail.vue)
