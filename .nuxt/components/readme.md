...
- `<ProductWrapperFurniture>` | `<product-wrapper-furniture>` (components/product/ProductWrapperFurniture.vue)
...
- `<HeroSliderBookStore>` | `<hero-slider-book-store>` (components/hero/HeroSliderBookStore.vue)
...
- `<HeroSliderFurniture>` | `<hero-slider-furniture>` (components/hero/HeroSliderFurniture.vue)
