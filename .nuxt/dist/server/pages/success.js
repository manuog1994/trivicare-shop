...
this.loading=false;this.countdown(10);this.$store.commit('CLEAR_GUEST');this.$store.commit('CLEAR_CART');this.$store.commit('CLEAR_CUPON');}).catch(err=>{//console.log(err.response.data)
this.loading=false;this.countdown(20);this.paymentIntent=null;this.error='Ha ocurrido un error, por favor intente nuevamente más tarde.';});},// countdown of 10 seconds to redirect to my-orders
