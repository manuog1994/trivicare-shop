...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "render", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return staticRenderFns; });
var render=function render(){var _vm=this,_c=_vm._self._c;return _c("div",{staticClass:"shop-page-wrapper"},[_c("HeaderWithTopbar",{attrs:{containerClass:"container"}}),_vm._ssrNode(" "),_c("Breadcrumb",{attrs:{pageTitle:"Autentificación"}}),_vm._ssrNode(" "),_vm._ssrNode('<div class="login-register-area pt-100 pb-100">',"</div>",[_vm._ssrNode('<div class="container">',"</div>",[_vm._ssrNode('<div class="login-register-tab-list nav"><button title="Iniciar sesión"'+_vm._ssrClass(null,{active:_vm.isActive==="Login"})+'>\n                    Iniciar Sessión\n                </button> <button title="Registrarte"'+_vm._ssrClass(null,{active:_vm.isActive==="Register"})+">\n                    Regístrate\n                </button></div> "),_vm._ssrNode('<div class="row">',"</div>",[_vm._ssrNode('<div class="col-lg-7 col-12 ms-auto me-auto">',"</div>",[_c(_vm.isActive,{tag:"component"})],1)])],2)]),_vm._ssrNode(" "),_c("TheFooter"),_vm._ssrNode(" "),_c("VueIfBot",[_c("CookieConsent",[_c("template",{slot:"message"},[_c("span",[_vm._v("\n                    Este sitio web utiliza cookies para mejorar tu experiencia. Si quieres saber más, visita nuestra \n                    "),_c("a",{staticClass:"text-info",attrs:{href:"/politica-de-cookies"}},[_vm._v("Política de Cookies")]),_vm._v(".\n                ")])]),_vm._v(" "),_c("template",{slot:"button"},[_c("button",{staticClass:"btn border-1",attrs:{title:"Aceptar"}},[_vm._v("Aceptar")])])],2)],1)],2);};var staticRenderFns=[];render._withStripped=true;
