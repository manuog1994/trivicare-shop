...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "render", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return staticRenderFns; });
var render=function render(){var _vm=this,_c=_vm._self._c;return _c("div",{staticClass:"shop-page-wrapper"},[_c("HeaderWithTopbar",{attrs:{containerClass:"container-fluid"}}),_vm._ssrNode(" "),_c("Breadcrumb",{attrs:{pageTitle:"Recuperación de contraseña"}}),_vm._ssrNode(" "+(_vm.send==false?'<div class="login-form" data-v-10645fc8><div data-v-10645fc8><h2 data-v-10645fc8>Recuperación de contraseña</h2> <p data-v-10645fc8>Se enviara un correo electrónico a la dirección que nos has indicado, si está registrada en nuestros registros.</p></div> <form data-v-10645fc8><div class="mb-2" data-v-10645fc8><label for="email" data-v-10645fc8>Email</label> <input type="email" name="email" class="form-control" data-v-10645fc8></div> <div class="mb-2" data-v-10645fc8><button type="submit" title="Recuperar la contraseña" class="btn-form" data-v-10645fc8>Recuperar la contraseña</button></div></form></div>':"<!---->")+" "+(_vm.send==true?'<div class="login-form" data-v-10645fc8><div data-v-10645fc8><h2 class="text-center" data-v-10645fc8>El correo se ha enviado con éxito</h2> <p data-v-10645fc8>Dirijase al bandeja de entrada de su correo electrónico y siga las instrucciones.</p> <p data-v-10645fc8>No olvide revisar la bandeja de Spam en el caso de que no lo encuentre.</p></div></div>':"<!---->")+" "),_c("TheFooter"),_vm._ssrNode(" "),_c("VueIfBot",[_c("CookieConsent",[_c("template",{slot:"message"},[_c("span",[_vm._v("\n                    Este sitio web utiliza cookies para mejorar tu experiencia. Si quieres saber más, visita nuestra \n                    "),_c("a",{staticClass:"text-info",attrs:{href:"/privacy-policy"}},[_vm._v("Política de Cookies")]),_vm._v(".\n                ")])]),_vm._v(" "),_c("template",{slot:"button"},[_c("button",{staticClass:"btn border-1"},[_vm._v("Aceptar")])])],2)],1)],2);};var staticRenderFns=[];render._withStripped=true;
