exports.ids = [49,7,15,19,25,26,27,40];
exports.modules = {
...
/* harmony default export */ var comparevue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 85)),Breadcrumb:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 83)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 82))},computed:{products(){return this.$store.getters.getCompare;}},mounted(){var tituloOriginal=document.title;// Lo guardamos para restablecerlo
