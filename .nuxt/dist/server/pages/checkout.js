...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "render", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return staticRenderFns; });
var render=function render(){var _vm=this,_c=_vm._self._c;return _c("client-only",[_c("div",{staticClass:"cart-page-wrapper"},[_c("HeaderWithTopbar",{attrs:{containerClass:"container-fluid"}}),_vm._v(" "),_c("TheHeader",{attrs:{searchFather:_vm.searchChildren},on:{opacity:_vm.searchOpacity}}),_vm._v(" "),_c("div",{attrs:{id:"post-nav"},on:{click:_vm.closeMenus}},[_c("NavBottom"),_vm._v(" "),_c("CheckoutContainer"),_vm._v(" "),_c("TheFooter"),_vm._v(" "),_c("VueIfBot",[_c("CookieConsent",[_c("template",{slot:"message"},[_c("span",[_vm._v("\n                            Este sitio web utiliza cookies para mejorar tu experiencia. Si quieres saber más, visita nuestra \n                            "),_c("a",{staticClass:"text-info",attrs:{href:"/privacy-policy"}},[_vm._v("Política de Cookies")]),_vm._v(".\n                        ")])]),_vm._v(" "),_c("template",{slot:"button"},[_c("button",{staticClass:"btn border-1"},[_vm._v("Aceptar")])])],2)],1)],1)],1)]);};var staticRenderFns=[];render._withStripped=true;
