...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "render", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return staticRenderFns; });
var render=function render(){var _vm=this,_c=_vm._self._c;return _c("div",{staticClass:"about-page-wrapper"},[_c("HeaderWithTopbar",{attrs:{containerClass:"container-fluid"}}),_vm._ssrNode(" "),_c("TheHeader",{attrs:{searchFather:_vm.searchChildren},on:{opacity:_vm.searchOpacity}}),_vm._ssrNode(" "),_vm._ssrNode('<div id="post-nav">',"</div>",[_c("NavBottom"),_vm._ssrNode(" "),_c("WelcomeMessage",{staticClass:"pt-100 pb-95"}),_vm._ssrNode(" "),_c("BannerStyleOne",{staticClass:"pb-70"}),_vm._ssrNode(" "),_c("AboutMission"),_vm._ssrNode(" "),_c("FunFact"),_vm._ssrNode(" "),_c("TeamMembers"),_vm._ssrNode(" "),_c("BrandLogoCarousel"),_vm._ssrNode(" "),_c("TheFooter"),_vm._ssrNode(" "),_c("VueIfBot",[_c("CookieConsent",[_c("template",{slot:"message"},[_c("span",[_vm._v("\n                        Este sitio web utiliza cookies para mejorar tu experiencia. Si quieres saber más, visita nuestra \n                        "),_c("a",{staticClass:"text-info",attrs:{href:"/privacy-policy"}},[_vm._v("Política de Cookies")]),_vm._v(".\n                    ")])]),_vm._v(" "),_c("template",{slot:"button"},[_c("button",{staticClass:"btn border-1"},[_vm._v("Aceptar")])])],2)],1)],2)],2);};var staticRenderFns=[];render._withStripped=true;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue_if_bot_dist_vue_if_bot_es__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-if-bot/dist/vue-if-bot.es */ "./node_modules/vue-if-bot/dist/vue-if-bot.es.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({auth:false,components:{HeaderWithTopbar:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/HeaderWithTopbar */ "./components/HeaderWithTopbar.vue")),TheHeader:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/TheHeader */ "./components/TheHeader.vue")),NavBottom:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/NavBottom */ "./components/NavBottom.vue")),WelcomeMessage:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/WelcomeMessage */ "./components/WelcomeMessage.vue")),BannerStyleOne:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/banner/BannerStyleOne */ "./components/banner/BannerStyleOne.vue")),AboutMission:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/AboutMission */ "./components/AboutMission.vue")),FunFact:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/FunFact */ "./components/FunFact.vue")),TeamMembers:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/TeamMembers */ "./components/TeamMembers.vue")),BrandLogoCarousel:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/BrandLogoCarousel */ "./components/BrandLogoCarousel.vue")),TheFooter:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/TheFooter */ "./components/TheFooter.vue")),VueIfBot: vue_if_bot_dist_vue_if_bot_es__WEBPACK_IMPORTED_MODULE_0__["default"],CookieConsent: vue_cookieconsent_component_src_components_CookieConsent_vue__WEBPACK_IMPORTED_MODULE_1__["default"]},data(){return{searchChildren:''};},head(){return{title:"Sobre Nosotros",meta:[{charset:'utf-8'},{name:'viewport',content:'width=device-width, initial-scale=1'},{hid:'description',name:'description',content:'Somos una empresa de cosmética natural y ecológica, con productos de alta calidad y con ingredientes naturales y ecológicos.'}]};},mounted(){this.$nextTick(()=>{this.$nuxt.$loading.start();setTimeout(()=>{this.$nuxt.$loading.finish();},2000);});var tituloOriginal=document.title;// Lo guardamos para restablecerlo
