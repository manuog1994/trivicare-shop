...
var render=function render(){var _vm=this,_c=_vm._self._c;return _c("client-only",[_c("div",{staticClass:"home-cosmetics"},[_c("NavBottom"),_vm._v(" "),_c("HeaderWithTopbar",{attrs:{containerClass:"container-fluid"}}),_vm._v(" "),_c("TheHeader",{attrs:{searchFather:_vm.searchChildren},on:{opacity:_vm.searchOpacity}}),_vm._v(" "),_c("div",{attrs:{id:"post-nav"},on:{click:_vm.closeMenus}},[_c("HeroSliderSix"),_vm._v(" "),_c("IconsActions"),_vm._v(" "),_c("ProductWrapperCosmetics"),_vm._v(" "),_c("Testimonials"),_vm._v(" "),_c("ServicePolicyFour"),_vm._v(" "),_c("TheFooter")],1),_vm._v(" "),_vm.loaderPage?_c("BigLoader"):_vm._e()],1)]);};var staticRenderFns=[];render._withStripped=true;
