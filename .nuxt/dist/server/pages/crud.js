...
var render=function render(){var _vm=this,_c=_vm._self._c;return _c("client-only",[_c("div",{staticClass:"home-cosmetics"},[_c("Nav"),_vm._v(" "),_c("div",{staticClass:"login-register-area pt-5 pb-100"},[_c("div",{staticClass:"container"},[_c("div",{staticClass:"d-flex justify-content-center mb-5"},[_c("select",{staticClass:"form-select",on:{change:_vm.openOption}},[_c("option",{class:{active:_vm.isActive==="All"},attrs:{value:"All"},on:{click:function($event){return _vm.comA("All");}}},[_vm._v("Todos los productos")]),_vm._v(" "),_c("option",{class:{active:_vm.isActive==="Create"},attrs:{value:"Create"},on:{click:function($event){return _vm.comA("Create");}}},[_vm._v("Crear producto")]),_vm._v(" "),_c("option",{class:{active:_vm.isActive==="Orders"},attrs:{value:"Orders"},on:{click:function($event){return _vm.comA("Orders");}}},[_vm._v("Pedidos")]),_vm._v(" "),_c("option",{class:{active:_vm.isActive==="OrdersHistory"},attrs:{value:"OrdersHistory"},on:{click:function($event){return _vm.comA("OrdersHistory");}}},[_vm._v("Historial de pedidos")]),_vm._v(" "),_c("option",{class:{active:_vm.isActive==="Coupons"},attrs:{value:"Coupons"},on:{click:function($event){return _vm.comA("Coupons");}}},[_vm._v("Cupones")]),_vm._v(" "),_c("option",{class:{active:_vm.isActive==="NewInvoice"},attrs:{value:"NewInvoice"},on:{click:function($event){return _vm.comA("NewInvoice");}}},[_vm._v("Nueva Factura")]),_vm._v(" "),_c("option",{class:{active:_vm.isActive==="FormReview"},attrs:{value:"FormReview"},on:{click:function($event){return _vm.comA("FormReview");}}},[_vm._v("Formulario de valoración")]),_vm._v(" "),_c("option",{class:{active:_vm.isActive==="Newsletter"},attrs:{value:"Newsletter"},on:{click:function($event){return _vm.comA("Newsletter");}}},[_vm._v("Newsletter")])])]),_vm._v(" "),_c("div",{staticClass:"row"},[_c("div",{},[_c(_vm.isActive,{tag:"component"})],1)])])])],1)]);};var staticRenderFns=[];render._withStripped=true;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ({auth:true,components:{TheHeader:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/TheHeader */ "./components/TheHeader.vue")),TheFooter:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/TheFooter */ "./components/TheFooter.vue")),Nav:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Nav */ "./components/crud/Nav.vue")),All:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/All */ "./components/crud/All.vue")),Create:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Create */ "./components/crud/Create.vue")),Orders:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Orders */ "./components/crud/Orders.vue")),OrdersHistory:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/OrdersHistory */ "./components/crud/OrdersHistory.vue")),Coupons:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Coupons */ "./components/crud/Coupons.vue")),NewInvoice:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/NewInvoice */ "./components/crud/NewInvoice.vue")),FormReview:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/FormReview */ "./components/crud/FormReview.vue")),Newsletter:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Newsletter */ "./components/crud/Newsletter.vue"))},data(){return{isActive:"All",unauthorized:''};},mounted(){this.$nextTick(()=>{this.$nuxt.$loading.start();setTimeout(()=>{this.$nuxt.$loading.finish();},2000);});if(this.$axios.onError(error=>{const code=error.response.status;if(code==401){this.$auth.logout();}}));},methods:{comA(item){this.isActive=item;},openOption(e){let option=e.target.value;this.comA(option);}},head(){return{title:"Panel de Control"};}});
