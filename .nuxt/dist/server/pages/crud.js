...
var render=function render(){var _vm=this,_c=_vm._self._c;return _vm.role=="admin"?_c("div",{staticClass:"home-cosmetics"},[_c("Nav"),_vm._ssrNode(" "),_vm._ssrNode('<div class="login-register-area pt-5 pb-100">',"</div>",[_vm._ssrNode('<div class="container">',"</div>",[_vm._ssrNode('<div class="login-register-tab-list nav"><button title="Ver todos los productos"'+_vm._ssrClass(null,{active:_vm.isActive==="All"})+'>\n                    Todos los productos\n                </button> <button title="Crear producto"'+_vm._ssrClass(null,{active:_vm.isActive==="Create"})+'>\n                    Crear producto\n                </button> <button title="Pedidos"'+_vm._ssrClass(null,{active:_vm.isActive==="Orders"})+'>\n                    Pedidos\n                </button> <button title="Historial de pedidos"'+_vm._ssrClass(null,{active:_vm.isActive==="OrdersHistory"})+'>\n                    Historial de Pedidos\n                </button> <button title="Cupones"'+_vm._ssrClass(null,{active:_vm.isActive==="Coupons"})+">\n                    Cupones\n                </button></div> "),_vm._ssrNode('<div class="row">',"</div>",[_vm._ssrNode("<div>","</div>",[_c(_vm.isActive,{tag:"component"})],1)])],2)])],2):_vm._e();};var staticRenderFns=[];render._withStripped=true;
