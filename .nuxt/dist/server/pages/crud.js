...
var render=function render(){var _vm=this,_c=_vm._self._c;return _c("client-only",[_c("div",{staticClass:"home-cosmetics"},[_c("Nav"),_vm._v(" "),_c("div",{staticClass:"login-register-area pt-5 pb-100"},[_c("div",{staticClass:"container"},[_c("div",{staticClass:"login-register-tab-list nav"},[_c("button",{class:{active:_vm.isActive==="All"},attrs:{title:"Ver todos los productos"},on:{click:function($event){return _vm.comA("All");}}},[_vm._v("\n                        Todos los productos\n                    ")]),_vm._v(" "),_c("button",{class:{active:_vm.isActive==="Create"},attrs:{title:"Crear producto"},on:{click:function($event){return _vm.comA("Create");}}},[_vm._v("\n                        Crear producto\n                    ")]),_vm._v(" "),_c("button",{class:{active:_vm.isActive==="Orders"},attrs:{title:"Pedidos"},on:{click:function($event){return _vm.comA("Orders");}}},[_vm._v("\n                        Pedidos\n                    ")]),_vm._v(" "),_c("button",{class:{active:_vm.isActive==="OrdersHistory"},attrs:{title:"Historial de pedidos"},on:{click:function($event){return _vm.comA("OrdersHistory");}}},[_vm._v("\n                        Historial de Pedidos\n                    ")]),_vm._v(" "),_c("button",{class:{active:_vm.isActive==="Coupons"},attrs:{title:"Cupones"},on:{click:function($event){return _vm.comA("Coupons");}}},[_vm._v("\n                        Cupones\n                    ")])]),_vm._v(" "),_c("div",{staticClass:"row"},[_c("div",{},[_c(_vm.isActive,{tag:"component"})],1)])])])],1)]);};var staticRenderFns=[];render._withStripped=true;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ({auth:true,components:{TheHeader:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/TheHeader */ "./components/TheHeader.vue")),TheFooter:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/TheFooter */ "./components/TheFooter.vue")),Nav:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Nav */ "./components/crud/Nav.vue")),All:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/All */ "./components/crud/All.vue")),Create:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Create */ "./components/crud/Create.vue")),Orders:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Orders */ "./components/crud/Orders.vue")),OrdersHistory:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/OrdersHistory */ "./components/crud/OrdersHistory.vue")),Coupons:()=>Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/crud/Coupons */ "./components/crud/Coupons.vue"))},data(){return{isActive:"All"};},mounted(){this.$nextTick(()=>{this.$nuxt.$loading.start();setTimeout(()=>{this.$nuxt.$loading.finish();},2000);});},methods:{comA(item){this.isActive=item;},head(){return{title:"Panel de Control"};}}});
