...
/* build-hook-start *//*00001*/try { require('/Users/manuelortegagaliano/.vscode/extensions/wallabyjs.console-ninja-0.0.84/out/buildHook/index.js').default({tool: 'nuxt'}); } catch(e) { try { import('file:///Users/manuelortegagaliano/.vscode/extensions/wallabyjs.console-ninja-0.0.84/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(p => {}) } catch(e) { }}/* build-hook-end */
