/*!
 * @nuxt/generator-edge v2.17.0-27993619.fa6255f (c) 2016-2023
...
Please run \`nuxt build\``
  ...
  getBuildConfig() {
    try {
      return utilsEdge.requireModule(path.join(this.options.buildDir, "nuxt/config.json"));
    } catch (err) {
      return null;
    }
  }
  getAppRoutes() {
    return utilsEdge.requireModule(path.join(this.options.buildDir, "routes.json"));
  }
