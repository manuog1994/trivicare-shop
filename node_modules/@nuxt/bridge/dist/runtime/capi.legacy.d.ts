...
export declare const useContext: () => {
    ...
    $parent: import("vue").default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => import("vue").default<Record<string, any>, Record<string, any>, never, never, any>>;
    ...
    $el: Element;
    $refs: {
        [key: string]: Element | import("vue").default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => import("vue").default<Record<string, any>, Record<string, any>, never, never, any>> | (Element | import("vue").default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => import("vue").default<Record<string, any>, Record<string, any>, never, never, any>>)[];
    };
    $slots: {
    ...
    $mount(elementOrSelector?: string | Element, hydrating?: boolean): import("vue").default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => import("vue").default<Record<string, any>, Record<string, any>, never, never, any>>;
    $forceUpdate(): void;
    $destroy(): void;
    $set: {
    ...
    $watch(expOrFn: string, callback: (this: import("vue").default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => import("vue").default<Record<string, any>, Record<string, any>, never, never, any>>, n: any, o: any) => void, options?: import("vue").WatchOptions): () => void;
    $watch<T_3>(expOrFn: (this: import("vue").default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => import("vue").default<Record<string, any>, Record<string, any>, never, never, any>>) => T_3, callback: (this: import("vue").default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => import("vue").default<Record<string, any>, Record<string, any>, never, never, any>>, n: T_3, o: T_3) => void, options?: import("vue").WatchOptions): () => void;
    ...
    $off(event?: string | string[], callback?: Function): import("vue").default<Record<string, any>, Record<string, any>, never, never, (event: string, ...args: any[]) => import("vue").default<Record<string, any>, Record<string, any>, never, never, any>>;
