    ...
    <div v-if="product.status == 'Publicado'" class="product-wrap-3 mb-20">
        <div class="product-img">
            <n-link :to="`/product/${slugify(product.title)}`">
                ...
                <div v-else>
                    <nuxt-img loading="lazy" class="default-img" provider="customProvider" :src="product.images[0].path" :alt="product.title" width="269.99" height="269.99"/>
                    <nuxt-img loading="lazy" class="hover-img" provider="customProvider" :src="product.images[0].path" :alt="product.title" width="269.99" height="269.99"/>
                </div>
            </n-link>
