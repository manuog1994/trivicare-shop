                                        ...
                                        <div class="row d-md-flex line-cart mt-md-4 mt-2" v-for="product, index in products" :key="product.id + 'product' + index">
                                            <div class="col-4 col-md-2 p-2 ms-4">
                                                <n-link :to="`/product/${product.slug}`">
                                                    <nuxt-img loading="lazy" v-if="product.images?.length > 0 && product.variation == null" provider="customProvider" :src="product.images[0].path + '270x360/' + product.images[0].name + '.' + product.images[0].ext" :alt="product.name"/> 
